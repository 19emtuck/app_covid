...
exports.generatePdf = async function (profile, reasons, existingPdfBytes) {
  ...
  const generatedQR = await util.generateQR(data)

  const qrImage = await pdfDoc.embedPng(generatedQR)

  page1.drawText(qrTitle1 + '\n' + qrTitle2, { x: 440, y: 630, size: 6, font, lineHeight: 10, color: pdflib.rgb(1, 1, 1) })
